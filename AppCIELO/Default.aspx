...
<head runat="server">
    ...
    <link rel="stylesheet" href="css/keyboard-basic.css" type="text/css" />      
    ...
    // 'keyb_change' and 'keyb_callback' functions
        ...
        $(document).ready(function () {
            $("#txthabi").keyboard({
                ...
                display:{
                    'a': '<img src="imagenes/ic_ok.png">',
                    'c': '<img src="imagenes/ic_cancel.ico">'
                },
                position: {
                    of: null,
                    my: 'left top',
            ...
            /*$("#txthabi").on("change", function () {
                setTimeout(function () { $("input[id='txtBrazalete']").focus() }, 500);
            });*/

            $("#txtBrazalete").on("change", function () {
                //$("#btnEnviar").click();
            });

            $("#txtBrazalete").focusin(function () {
                $("#txtBrazalete").keyboard({
                    layout: 'custom',
                    customLayout: {
                        'normal': [
                            '7 8 9 {b}',
    ...
    function keyb_callback(ch) {
        ...
        switch (ch) {
            ...
            case "Enter":
                opened = !opened;
                if (id == "txthabi")
                    keyb_change("txtBrazalete");
                else {
                    var elem = document.getElementById("btnEnviar");
                    elem.click();
                }
                break;
...
<body>
    <form id="form1" runat="server">
       ...
       <div class="item html">
        ...
        <div class="container">
            <div>
                <asp:Label ID="lblHeadOne" runat="server" Text=""></asp:Label>
            </div>
            ...
            <div>
                <asp:TextBox ID="txthabi" ClientID="txthabi" runat="server" Style="text-align: center" CssClass="txt txth" ToolTip="Please type your room" Placeholder="" ></asp:TextBox>
            </div>
             <div>
                <asp:TextBox ID="txtBrazalete" ClientID="txtBrazalete" runat="server" Style="text-align: center" CssClass="txt" Placeholder="#Bracelet" ></asp:TextBox>
            </div>

            <p>
                <!--a href="javascript:keyb_change('txthabi')" id="switch"-->                  
                <!--img id="ic_keyboard" src="imagenes/teclado.gif" alt="teclado" /-->
            </p>

            <div>
                <asp:Button ID="btnEnviar" ClientID="btnEnviar" runat="server" Text="" CssClass="btn" OnClick="btnEnviar_Click" Font-Size="X-Large"/>
            </div>  
